...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitDomaininfoRouter(PrivateGroup)                 // 域名
		router.InitHtmlinfoRouter(PrivateGroup)		//网页信息
		router.InitBlackwordRouter(PrivateGroup)		// 灰黑词
		router.InitMissionRouter(PrivateGroup)		// 任务
	}
